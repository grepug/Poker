...
export default defineConfig({
  ...
  webServer: [
    ...
    },
    {
      ...
      command: `pnpm build && rm -rf ${E2E_DATA_DIR} && PORT=${BACKEND_PORT} DATA_DIR=${E2E_DATA_DIR} CORS_ORIGIN=${FRONTEND_URL} CLIENT_URL=${FRONTEND_URL} TEST_MODE=true CHAT_RATE_LIMIT_COUNT=500 CHAT_RATE_LIMIT_WINDOW_MS=10000 CHAT_PAGE_SIZE=20 AUTH_PASSWORD_LOGIN_RATE_LIMIT_COUNT=1000 AUTH_PASSWORD_LOGIN_RATE_LIMIT_WINDOW_MS=1000 pnpm run start:prod`,
      url: BACKEND_URL,
      reuseExistingServer: false,
      timeout: 120000,
      env: backendEnv,
