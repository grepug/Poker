...
const toActionCenterAlert = (event: PlayerActionFlashEvent): ActionCenterAlert => {
...
export const GameRoom: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const alert = toActionCenterAlert(lastPlayerActionEvent);
  ...
  }, [clearActionAlertTimers, lastPlayerActionEvent]);
