...
const seatOrbitItems: SeatOrbitItems = [
  {
    ...
    playerName: "Kai",
    isYou: true,
    badge: { placement: "corner", icon: "dealer" as const, text: "BTN" },
  ...
  },
  {
    ...
    playerName: "Maya",
    isYou: false,
    badge: { placement: "corner", icon: "small-blind" as const, text: "SB" },
  ...
  },
  {
    ...
    playerName: "Noah",
    isYou: false,
    badge: { placement: "inline", icon: null, text: "BB" },
    externalStatusLabel: null,
    externalStatusToneClass: "",
  ...
  },
  {
    ...
    playerName: "Jin",
    isYou: false,
    badge: { placement: "inline", icon: null, text: "HJ" },
    externalStatusLabel: null,
    externalStatusToneClass: "",
  ...
  },
  {
    ...
    playerName: "Eve",
    isYou: false,
    badge: { placement: "inline", icon: null, text: "CO" },
    externalStatusLabel: null,
    externalStatusToneClass: "",
    internalStatusLabel: null,
    internalStatusToneClass: "",
...
const eightHandedStatusSeatOrbitItems: SeatOrbitItems = [
  {
    ...
    playerName: "你",
    isYou: true,
    badge: { placement: "corner", icon: "dealer" as const, text: "D" },
